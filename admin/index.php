...
$yash_query="select username from users where username='$user_n' and role='author'";
$yash_run=mysqli_query($con,$yash_query);
 if(mysqli_num_rows($yash_run) > 0)
 {
      while($yash_row = mysqli_fetch_array($yash_run))
      {
          $c_user = $yash_row['username'];
          echo $c_user;
      }
     $yash2_query="select * from posts where author='$c_user'";
     $yash2_run=mysqli_query($con,$yash2_query);
     $yash2_rows=mysqli_num_rows($yash2_run);
     echo $yash2_rows;
     $y=1;
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                            ...
                            <div class="panel panel-red">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9">
                                            <div class="text-right huge"><?php if($y==0){echo $post_rows;} else{echo $yash2_rows;}?></div>
                    ...
                    <?php 
                            if(($y)==0)
                            {
                                echo "<a href=".'"users.php"'.'class="btn btn-primary"'.">View All Users</a><hr>";
                            }
                    ?>
                    ...
                    <table class="table">
                     ...
                     <?php 
                            if(($y)==0)
                            {
                                echo "<a href=".'"posts.php"'.'class="btn btn-primary"'.">View All Posts</a>";
                            }
                    ?>
